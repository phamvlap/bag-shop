	...
	<ul class="pagination justify-content-center">
		<?php if(isset($_SESSION['filter-pagination'])): ?>
			...
			<li class="page-item <?php echo $_SESSION['filter-pagination']['prevPage'] ? '' : 'disabled' ?>">
				<a class="page-link px-4 py-3" href="/admin/product/filter?<?php echo $queryUrl . 'page=' . $_SESSION['filter-pagination']['prevPage'] ?>&limit=5" aria-label="Previous">
			...
			<?php foreach($_SESSION['filter-pagination']['pages'] as $page): ?> 
				<li class="page-item">
					<a class="page-link px-4 py-3 <?php echo ($_SESSION['filter-pagination']['currPage'] === $page) ? 'active-status' : '' ?> " href="/admin/product/filter?<?php echo $queryUrl . 'page=' . $page ?>&limit=5">
						<?= $page ?>
					</a>
				</li>
			<?php endforeach ?>
			...
			<li class="page-item <?php echo $_SESSION['filter-pagination']['nextPage'] ? '' : 'disabled' ?>">
				<a class="page-link px-4 py-3" href="/admin/product/filter?<?php echo $queryUrl . 'page=' . $_SESSION['filter-pagination']['nextPage'] ?>&limit=5" aria-label="Next">
		...
		<?php elseif(isset($_SESSION['search-pagination'])): ?>
			...
			<li class="page-item <?php echo $_SESSION['search-pagination']['prevPage'] ? '' : 'disabled' ?>">
				<a class="page-link px-4 py-3" href="/admin/product/search?<?php echo (strlen($queryUrl) > 0) ? $queryUrl : '' ?><?= '&page=' . $_SESSION['search-pagination']['prevPage'] ?>&limit=5" aria-label="Previous">
					<span aria-hidden="true">&laquo;</span>
				</a>
			</li>
			...
			<?php foreach($_SESSION['search-pagination']['pages'] as $page): ?> 
				<li class="page-item">
					<a class="page-link px-4 py-3 <?php echo ($_SESSION['search-pagination']['currPage'] === $page) ? 'active-status' : '' ?> " href="/admin/product/search?<?php echo (strlen($queryUrl) > 0) ? $queryUrl : '' ?><?= '&page=' . $page ?>&limit=5">
						<?= $page ?>
					</a>
				</li>
			<?php endforeach ?>
			...
			<li class="page-item <?php echo $_SESSION['search-pagination']['nextPage'] ? '' : 'disabled' ?>">
				<a class="page-link px-4 py-3" href="/admin/product/search?<?php echo (strlen($queryUrl) > 0) ? $queryUrl : '' ?><?= '&page=' . $_SESSION['search-pagination']['nextPage'] ?>&limit=5" aria-label="Next">
					<span aria-hidden="true">&raquo;</span>
				</a>
			</li>
		...
		<?php elseif(isset($_SESSION['filter-invoices-pagination'])): ?>
			...
			<li class="page-item <?php echo $_SESSION['filter-invoices-pagination']['prevPage'] ? '' : 'disabled' ?>">
				<a class="page-link px-4 py-3" href="/admin/invoice/filter?<?php echo $queryUrl . 'page=' . $_SESSION['filter-invoices-pagination']['prevPage'] ?>&limit=10" aria-label="Previous">
					<span aria-hidden="true">&laquo;</span>
				</a>
			</li>
			...
			<?php foreach($_SESSION['filter-invoices-pagination']['pages'] as $page): ?> 
				<li class="page-item">
					<a class="page-link px-4 py-3 <?php echo ($_SESSION['filter-invoices-pagination']['currPage'] === $page) ? 'active-status' : '' ?> " href="/admin/invoice/filter?<?php echo $queryUrl . 'page=' . $page ?>&limit=10">
						<?= $page ?>
					</a>
				</li>
			<?php endforeach ?>
			...
			<li class="page-item <?php echo $_SESSION['filter-invoices-pagination']['nextPage'] ? '' : 'disabled' ?>">
				<a class="page-link px-4 py-3" href="/admin/invoice/filter?<?php echo $queryUrl . 'page=' . $_SESSION['filter-invoices-pagination']['nextPage'] ?>&limit=10" aria-label="Next">
					<span aria-hidden="true">&raquo;</span>
				</a>
			</li>

	...
	<div class="container content">
		<div class="row">
			...
			<div class="col-md-10 p-0">
				<div class="ms-2">
					<!-- Notify Search -->
					<div id="notify-search">
						<div class="bg-white rounded-2 p-3">
							<span>Tìm thấy <strong>120</strong> sản phẩm phù hợp với từ khóa</span>
							<strong>sữa milo</strong>
						</div>
					</div>
					<!-- Sort bar -->
					<div id="sort-bar">
						<?php require_once __DIR__ . '/Partials/SortBar.php'; ?>
					</div>
					<!-- Products -->
